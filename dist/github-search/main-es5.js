...
var AppComponent = /** @class */ (function () {
    function AppComponent(githubApi) {
...
var GithubApiService = /** @class */ (function () {
    ...
    GithubApiService.prototype.apiRequest = function (topic) {
        var _this = this;
        this.keyWords = topic;
        ...
        fetch("https://api.github.com/search/repositories?q=language:" + this.choosedLanguage + "+topic:" + topic)
            ...
            result.items.forEach(function (item) {
                ...
                _this.myRepoList.forEach(function (repo) {
                ...
                _this.repositoriesList.push(item);
                item.searchKeywords = [];
            ...
            if (_this.repositoriesList.length > 0) {
                _this.viewButtons = true;
            }
            if (_this.results.length > 0) {
                _this.notFoundResult = false;
            }
            else if (_this.results.length === 0) {
                _this.notFoundResult = true;
                _this.viewButtons = false;
            }
        });
    };
    GithubApiService.prototype.addRepoToMyList = function (repo) {
        var _this = this;
        var repoLenght = this.myRepoList.length;
        var check = true;
        for (var i = 0; i < repoLenght; i += 1) {
            var myRepo = this.myRepoList.shift();
            if (myRepo === repo) {
                check = false;
            }
            else {
        ...
        if (this.myListPage === true) {
            this.repositoriesList.length = 0;
            this.myRepoList.forEach(function (repo) {
                _this.repositoriesList.push(repo);
            });
        }
    };
    GithubApiService.prototype.switchOnMyList = function () {
        var _this = this;
    ...
    GithubApiService.prototype.switchOnSearch = function () {
        var _this = this;
        this.noMainPage = true;
        this.repositoriesList.length = 0;
        this.results.forEach(function (result) {
            ...
            _this.repositoriesList.push(result);
        });
        this.myListPage = false;
        this.searchPage = true;
    };
    GithubApiService.prototype.inputTopic = function (topic) {
    ...
    GithubApiService.prototype.changeViewOnPlitka = function () {
        this.plitkaDisplay = true;
        this.listDisplay = false;
    };
    GithubApiService.prototype.changeViewOnList = function () {
        this.plitkaDisplay = false;
        this.listDisplay = true;
    };
...
var MylistPageComponent = /** @class */ (function () {
    function MylistPageComponent() {
    }
    MylistPageComponent.prototype.ngOnInit = function () {
    };
...
var RepoListComponent = /** @class */ (function () {
    function RepoListComponent(githubApi) {
        this.githubApi = githubApi;
        this.plitkaDisplay = false;
        this.listDisplay = true;
    }
    ...
    RepoListComponent.prototype.starsNumber = function (stars) {
        if (stars > 1000) {
            var delStars = ("" + stars).split('');
            delStars.splice(-3);
            var resStars = delStars.join('');
            return (resStars + 'k');
        }
        else {
            return stars;
    ...
    RepoListComponent.ctorParameters = function () { return [
        { type: _github_api_service__WEBPACK_IMPORTED_MODULE_2__["GithubApiService"] }
    ]; };
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(githubApi) {
        this.githubApi = githubApi;
    ...
    SearchComponent.prototype.chooseLanguage = function (language) {
        this.githubApi.choosedLanguage = language;
    };
    SearchComponent.prototype.chooseType = function (type) {
        this.currentType = type;
    };
    SearchComponent.prototype.languagesListStatus = function () {
        return this.languagesListOpen;
    };
    SearchComponent.prototype.openList = function () {
    ...
    SearchComponent.prototype.openTypes = function () {
    ...
    SearchComponent.prototype.searchRepositories = function (inputTopic) {
